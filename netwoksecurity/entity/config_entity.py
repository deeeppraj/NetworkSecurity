...
class ModelTrainerconfig:
    def __init__(self,training_pipeline_config:training_pipeline_config):
        ...
        self.trained_model_file:str = os.path.join(self.model_trainer_dir,training_pipeline.MODEL_TRAINER_TRAINED_MODEL_DIR,training_pipeline.MODEL_TRAINER_TRAINED_MODEL_NAME)
        self.expected_accuracy:float  = training_pipeline.MODEL_TRAINER_EXPECTED_SCORE
        self.threshold:float = training_pipeline.MODEL_TRAINER_OVER_FIITING_UNDER_FITTING_THRESHOLD
